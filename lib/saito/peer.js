...
Peer.prototype.addSocketEvents = function addSocketEvents() {
  ...
  try {
	...
	console.log("Error triggered by: " + JSON.stringify(message));
      ...
      ///////////////////////////
      if (message.request == "offchain") {

	//
	// browsers get notified if ANYONE reports a 
	// chain split. Paranoia for now to start.
	//
...
console.log("X: check blockchain");
...
console.log("X: update sync data"); 
        //
...
console.log("X: last shared bid"); 
	  ...
	  //
	  if ( (this.app.blockchain.returnLatestBlockId() - peer_last_bid) > this.app.blockchain.genesis_period  && peer_last_bid != 0) {
...
console.log("Y: done with this stuff.... "); 
      }
