...
console.log("About to Send Request for Missing Block: ");
  ...
  //
    ...
    if (bid >= this.index.bid[this.lc]) {
      console.log("BID GREATER THAN LC VALUE")
      if (prevhash == this.index.hash[this.lc]) {
        console.log("I AM LONGEST CHAIN");
        i_am_the_longest_chain = 1;
      } else {
        ...
        console.log("NCHAIN_LEN: ", nchain_len);
        console.log("LCHAIN_LEN: ", lchain_len);
        console.log("NCHAIN_bf: ", nchain_bf);
        console.log("LCHAIN_bf: ", lchain_bf);
