...
function Blockchain(app) {
  ...
  this.callback_limit         = 10;  // run callbacks on 100 blocks
  this.lc                     = 0;
  this.old_lc                 = 0;
...
console.log(" .... start:       " + new Date().getTime() + " w/txs " + newblock.transactions.length);
...
console.log(" .... success:     " + new Date().getTime() + " w/txs "+newblock.transactions.length);
  //
  // update newblock
  //
  ...
  // the wallet update.
  //
console.log(" .... pre-save:    " + new Date().getTime() + " w/txs "+newblock.transactions.length);
  await this.app.storage.saveBlock(newblock, i_am_the_longest_chain);
console.log(" .... post-save:   " + new Date().getTime() + " w/txs "+newblock.transactions.length);
...
console.log(" .... into wallet: " + new Date().getTime() + " w/txs "+newblock.transactions.length);
...
console.log(" .... wallet done: " + new Date().getTime()  + " w/txs "+newblock.transactions.length);
...
console.log(" .... run callbks: " + new Date().getTime()  + " w/txs "+newblock.transactions.length);
  //
...
console.log(" .... done callbks:" + new Date().getTime());
  ...
  this.indexing_active = false;
console.log(" ... finished:   " + new Date().getTime()  + " w/txs "+newblock.transactions.length);
console.log("\n");
  return 1;
