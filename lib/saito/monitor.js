...
console.log(
this.app.mempool.bundling_active + "/" + 
this.app.mempool.processing_active + "/" + 
this.app.mempool.clearing_active + "/" + 
this.app.storage.loading_active + "/" + 
this.app.blockchain.indexing_active + "/" +
" BLKS in MEMPOOL: " + this.app.mempool.blocks.length
);
...
console.log(" ---> cannot add block to blockchain as block pool has " + this.app.mempool.blocks.length);
  return false;
}
