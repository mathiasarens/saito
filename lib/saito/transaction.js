...
function Transaction(txjson="") {
  ...
  this.fees_usable               = "";
  this.fees_publickey            = "";
  this.fees_cumulative           = "0.0"; // cumulative fees, inc. fees in this reflect
...
Transaction.prototype.clusterValidate = function clusterValidate(app) {
  ...
  ///////////////////////////
  console.log("VALIDATE SIG SOURCE: ", this.returnSignatureSource(app));
  console.log("TX: ", this.transaction);
  console.log("SENDER: ", this.returnSender());
